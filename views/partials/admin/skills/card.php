<div class="bg-white border border-gray-900 px-4 py-3 flex justify-between">
    ...
    <div class="self-center">
        <a href="/admin/skills/edit?skill=<?= $skill['id'] ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 cursor-pointer">
