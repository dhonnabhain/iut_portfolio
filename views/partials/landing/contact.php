<div class="bg-gradient-to-r from-indigo-600 via-cyan-500 to-blue-500 p-8">
    ...
    <form method="POST" action="/contact" class="space-y-8 max-w-2xl mx-auto bg-white p-6 pt-8 rounded-lg">
        ...
        <div>
            ...
            <p class="mt-2 text-sm text-gray-500" id="email-description">No spam, only response to your message, I promiss 😋</p>
        </div>

        <div>
            <label for="message" class="block text-sm font-medium text-gray-700">Message</label>
            <div class="mt-1">
                <textarea rows="4" name="message" id="message" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"></textarea>
            </div>
        </div>
